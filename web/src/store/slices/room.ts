...
export const roomSlice = createSlice({
  ...
  reducers: {
    ...
    updateRTCConfig: (state, { payload }) => {
      ...
      RtcClient.setBasicInfo(payload[state.scene]);
    },
    ...
    updateAIReadyState: (state, { payload }) => {
      state.isAIReady = payload.isAIReady;
    },
